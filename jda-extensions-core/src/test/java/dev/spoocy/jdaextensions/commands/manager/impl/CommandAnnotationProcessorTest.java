...
public class CommandAnnotationProcessorTest {
    ...
    public static class SubcommandContainerFixture {
     ...
     void defaultMethodsExist() {
         MethodAccessor defaultMethod = DefaultCommandAnnotationProcessor.INSTANCE.getDefaultMethod(SimpleCommandFixture.class);
         assertNotNull(defaultMethod);

         MethodAccessor defaultMethod2 = DefaultCommandAnnotationProcessor.INSTANCE.getDefaultMethod(SubcommandContainerFixture.class);
         assertNull(defaultMethod2);
     }

     @Test
     void subcommandMethodsExist() {
         Set<MethodAccessor> subcommandMethods = DefaultCommandAnnotationProcessor.INSTANCE.getSubCommandMethods(SimpleCommandFixture.class);
         assertNotNull(subcommandMethods);
         assertEquals(0, subcommandMethods.size());

         Set<MethodAccessor> subcommandMethods2 = DefaultCommandAnnotationProcessor.INSTANCE.getSubCommandMethods(SubcommandContainerFixture.class);
    ...
    void testParseDefaultCommand() {
        ...
        CommandData data = DefaultCommandAnnotationProcessor.INSTANCE.parseCommand(SimpleCommandFixture.class);
        ...
        assertEquals("flag", args.get(0).name());
    ...
    void testParseSubcommandsAndGroups() {
        ...
        assertEquals("text", sub2.getArgumentData().get(0).name());
    }
