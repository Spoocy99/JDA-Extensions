...
public class AdvancedEventManager implements IEventManager {
    ...
    protected final Set<Object> holders;
    ...
    public void register(@NotNull Object listener) {
        ...
        LOGGER.debug("Registering listener of class: {}", listener.getClass()
                .getSimpleName());
    }
    ...
    public void unregister(@NotNull Object listener) {
        ...
        LOGGER.debug("Unregistering listener of class: {}", listener.getClass()
                .getSimpleName());
    }
    ...
    protected void runListener(@NotNull EventListener listener, @NotNull GenericEvent event) {
        try {
