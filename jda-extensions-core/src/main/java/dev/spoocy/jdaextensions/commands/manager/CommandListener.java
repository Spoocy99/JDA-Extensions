...
public interface CommandListener {
    ...
    /**
     * Called when an unknown command is received.
     * <br> This is only called for slash commands.
     *
     * @param event the slash command interaction event
     */
    default void onUnknownCommand(@NotNull SlashCommandInteractionEvent event) {
        event.replyEmbeds(new EmbedBuilder().setDescription("Unknown Command.").setColor(Color.RED).build()).queue();
    }
