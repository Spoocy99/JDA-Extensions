...
public class IntegerArgument extends AbstractArgument {
    ...
    public IntegerArgument(
        ...
        this(Long.class, name, description, required, autoComplete);
    }
    ...
    public IntegerArgument minValue(@Nullable Long minValue) {
        this.minValue = minValue;
        return this;
    }

    public IntegerArgument maxValue(@Nullable Long maxValue) {
